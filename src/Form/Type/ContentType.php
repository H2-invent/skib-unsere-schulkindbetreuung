...
class ContentType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('slug', TextType::class, ['label' => 'Slug', 'required' => true, 'translation_domain' => 'form'])
            ...
            ->add('icon', TextType::class, ['label' => 'Icon (Fontawesome)', 'required' => true, 'translation_domain' => 'form'])

            ->add('activ', CheckboxType::class, ['label' => 'Content öffentlich', 'translation_domain' => 'form'])
            ->add('reihenfolge', NumberType::class, ['label' => 'Reihenfolge', 'translation_domain' => 'form'])
