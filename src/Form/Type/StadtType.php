...
class StadtType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('careBlockInfoDE', TextareaType::class, ['attr'=>['rows'=>3],'required'=>true,'label'=>'Betreuungszeitfenster Info Deutsch','translation_domain' => 'form', 'property_path' => 'translations[de].careBlockInfo', ])
            ->add('careBlockInfoEn', TextareaType::class, ['attr'=>['rows'=>3],'required'=>true,'label'=>'Betreuungszeitfenster Info Englisch','translation_domain' => 'form','property_path' => 'translations[en].careBlockInfo', ])
            ->add('careBlockInfoFr', TextareaType::class, ['attr'=>['rows'=>3],'required'=>true,'label'=>'Betreuungszeitfenster Info Französisch','translation_domain' => 'form','property_path' => 'translations[fr].careBlockInfo', ])
