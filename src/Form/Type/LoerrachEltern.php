...
class LoerrachEltern extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        if ($options['stadt']->getSettingsAnzahlKindergeldempfanger()) {
            $builder->add('anzahlKindergeldempfanger', NumberType::class, ['required' => $options['stadt']->getSettingsAnzahlKindergeldempfangerRequired(), 'label' => 'Anzahl der kindergeldberechtigten Kinder im selben Haushalt?']);
        }
