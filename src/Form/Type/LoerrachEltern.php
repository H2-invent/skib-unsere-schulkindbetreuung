    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
           ...
           ->add('abholberechtigter', TextareaType::class, ['required' => false, 'label' => 'Weitere abholberechtigte Personen', 'translation_domain' => 'form', 'attr' => ['rows' => 6]])
            ->add('gdpr', CheckboxType::class, ['required' => true, 'label' => 'Ich bin damit einverstanden, dass meine Daten und die Daten meiner Kinder von SKiB elektronisch verarbeitet werden und an betreuende Organisationen, sowie en Schulträger weitergegeben werden.', 'translation_domain' => 'form'])
