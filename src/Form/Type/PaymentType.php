...
class PaymentType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('bankName', TextType::class, ['required' => true, 'label' => 'Name der Bank', 'translation_domain' => 'form'])
            ->add('sepaAllowed', CheckboxType::class, ['required' => true, 'label' => 'SEPA-Lastschrift Mandat wird elektronisch erteilt', 'translation_domain' => 'form'])
