...
class FerienBlockType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('minAlter', IntegerType::class, ['required' => true, 'label' => 'Mindest Alter', 'translation_domain' => 'form'])
            ->add('maxAlter', IntegerType::class, ['required' => false, 'label' => 'Maximum Alter', 'translation_domain' => 'form'])
            ->add('startDate', DateType::class, ['widget' => 'single_text', 'label' => 'Datum Start', 'translation_domain' => 'form', 'attr' => ['class' => 'start date-hkjdshfsh']])
            ->add('endDate', DateType::class, ['widget' => 'single_text', 'label' => 'Datum Ende', 'translation_domain' => 'form', 'attr' => ['class' => 'end date-hkjdshfsh']])
            ...
            ->add('startVerkauf', DateType::class, ['widget' => 'single_text', 'label' => 'Start Vorverkauf', 'translation_domain' => 'form'])
            ->add('endVerkauf', DateType::class, ['widget' => 'single_text', 'label' => 'End Vorverkauf', 'translation_domain' => 'form'])
            ->add('maxAnzahl', IntegerType::class, ['required' => false, 'label' => 'Maximum Anzahl', 'translation_domain' => 'form'])
            ->add('anzahlPreise', IntegerType::class, ['required' => true, 'label' => 'Anzahl Preise', 'translation_domain' => 'form'])
            ->add('amountVoucher', IntegerType::class, ['required' => true, 'label' => 'Anzahl Gutscheine', 'translation_domain' => 'form'])
