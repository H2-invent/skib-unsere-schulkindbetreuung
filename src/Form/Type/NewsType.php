...
class NewsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('message', TextareaType::class, ['attr' => ['rows' => 6, 'class' => 'onlineEditor'], 'label' => 'Nachricht', 'required' => true, 'translation_domain' => 'form'])
            ->add('activ', CheckboxType::class, ['required' => false, 'label' => 'Neuigkeit auf der Startseite sichtbar', 'translation_domain' => 'form'])
