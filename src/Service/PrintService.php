...
class PrintService
{
    ...
    public function printAnmeldebestaetigung(Kind $kind, Stammdaten $eltern, Stadt $stadt, TCPDFController $tcpdf, $fileName, $beruflicheSituation, Organisation $organisation, $type = 'D', $encyption = false)
    {
        $pdf = $tcpdf->create();
